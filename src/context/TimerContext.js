...
export const themes = [
  ...
  { id: 'STARWARS', name: 'Star Wars', bg: '#000000', accent: '#FFE81F', secondary: '#444444', text: '#FFE81F', font: 'System', strokeLinecap: 'butt', borderRadius: 15, borderWidth: 1, borderColor: '#FFE81F' },
  { id: 'MINECRAFT', name: 'Minecraft', bg: '#181818', accent: '#589028', secondary: '#3C3C3C', text: '#FFFFFF', font: 'monospace', strokeLinecap: 'butt', borderRadius: 0, borderWidth: 4, borderColor: '#fff' },
  ...
  { id: 'GTA', name: 'GTA V', bg: '#254E29', accent: '#56AB2F', secondary: '#F1C40F', text: '#FFFFFF', font: 'System', strokeLinecap: 'butt', borderRadius: 12, borderWidth: 2, borderColor: '#F1C40F' },
  { id: 'AC', name: 'Assassins Creed', bg: '#2C3E50', accent: '#C0392B', secondary: '#ECF0F1', text: '#ECF0F1', font: 'serif', strokeLinecap: 'round', borderRadius: 25, borderWidth: 1, borderColor: '#ECF0F1' },
  ...
  { id: 'ONEPIECE', name: 'One Piece', bg: '#8B0000', accent: '#FFD700', secondary: '#000080', text: '#FFD700', font: 'serif', strokeLinecap: 'round', borderRadius: 40, borderWidth: 2, borderColor: '#FFFFFF' },
  { id: 'TITAN', name: 'Attack on Titan', bg: '#3E2723', accent: '#5D4037', secondary: '#D7CCC8', text: '#D7CCC8', font: 'serif', strokeLinecap: 'butt', borderRadius: 5, borderWidth: 1, borderColor: '#D7CCC8' },
