    ...
    <View style={styles.sectionContainer}>
      <View style={styles.sectionHeader}>
        ...
        <Text
          style={[
            styles.sectionTitle,
            { color: currentTheme.accent, fontFamily: currentTheme.font },
          ]}
        >
          {title.toUpperCase()}
        </Text>
    ...
    >
      ...
      {type === "switch" ? (
        ...
        <View style={styles.counterContainer}>
          <TouchableOpacity
            onPress={() => setter && setter(Math.max(1, (value as number) - 1))}
            style={[
              styles.counterBtn,
          ...
          <Text style={[styles.valueText, { color: currentTheme.text }]}>
            {value}
          </Text>
          <TouchableOpacity
            onPress={() => setter && setter((value as number) + 1)}
            style={[
              styles.counterBtn,
              { backgroundColor: currentTheme.secondary },
            ]}
  ...
  return (
    <View style={[styles.container, { backgroundColor: currentTheme.bg }]}>
      ...
      >
        ...
        <SettingSection
          title={t("appSettings") as string}
          icon="options-outline"
        >
          <SettingRow
            label={t("soundEffects") as string}
            value={isSoundEnabled}
            onToggle={setIsSoundEnabled}
          />
          <SettingRow
            label={t("bgEffects") as string}
            value={showParticles}
          ...
          <TouchableOpacity
            style={[
              styles.row,
              { borderBottomColor: currentTheme.secondary + "20" },
            ]}
          ...
          >
            ...
            >
              ...
              <Text
                style={{ color: currentTheme.text, opacity: 0.7, fontSize: 14 }}
              >
                {currentLang.label}
              </Text>
              <Ionicons
        ...
        <SettingSection
          title={t("timerSettings") as string}
          icon="timer-outline"
        >
          <SettingRow
            label={t("focusTime") as string}
            value={workTime}
            type="number"
            setter={setWorkTime}
          />
          <SettingRow
            label={t("shortBreakTime") as string}
            value={shortBreakTime}
            type="number"
            setter={setShortBreakTime}
          />
          <SettingRow
            label={t("longBreakTime") as string}
            value={longBreakTime}
            type="number"
        ...
        <SettingSection
          title={t("automation") as string}
          icon="construct-outline"
        >
          <SettingRow
            label={t("autoStartBreak") as string}
            value={autoStartBreak}
            onToggle={setAutoStartBreak}
          />
          <SettingRow
            label={t("autoStartFocus") as string}
            value={autoStartPomodoro}
            onToggle={setAutoStartPomodoro}
          />
          <SettingRow
            label={t("longBreakInterval") as string}
            value={longBreakInterval}
            type="number"
            setter={setLongBreakInterval}
          />
        </SettingSection>

        <SettingSection
          title={t("howToUse") as string}
